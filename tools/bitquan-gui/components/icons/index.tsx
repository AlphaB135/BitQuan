...
export const ThermometerIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2a5 5 0 00-5 5v8.586a1 1 0 00.293.707l3.414 3.414a1 1 0 001.414 0l3.414-3.414A1 1 0 0017 15.586V7a5 5 0 00-5-5zM12 11v6" />
  </svg>
);
